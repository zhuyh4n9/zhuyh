...
#define LEGAL_CHARACTER  "abcdefghijklmnopqrstuvwxyz._0123456789"
    ...
    bool Config::listAllItem(const std::string &prefix,
        ...
        if (node.IsMap()) {
            for (auto it = node.begin();
                ...
                if (str.find_first_not_of("abcdefghijklmnopqrstuvwxyz._0123456789") != std::string::npos)
                {
                    return false;
                }
